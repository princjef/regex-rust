...
impl fmt::Show for Instruction {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    match *self {
      ...
      InstAssertStart           => write!(f.buf, "InstAssertStart"),
      InstAssertStartMultiline  => write!(f.buf, "InstAssertStartMultiline"),
      InstAssertEnd             => write!(f.buf, "InstAssertEnd"),
      InstAssertEndMultiline    => write!(f.buf, "InstAssertEndMultiline"),
